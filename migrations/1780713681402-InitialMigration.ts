...
export class InitialMigration1780713681402 implements MigrationInterface {
    name = 'InitialMigration1780713681402'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sharing" ("id" SERIAL NOT NULL, "note" character varying, "receiverEmail" character varying NOT NULL, "senderEmail" character varying DEFAULT 'anonymous@no-email.remshare', "password" character varying NOT NULL, "files" text NOT NULL, "uniqueId" character varying NOT NULL, CONSTRAINT "PK_f8c5f77f3801cd2e106cbaed480" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "share_file" ("id" SERIAL NOT NULL, "url" character varying, CONSTRAINT "PK_872cafc7a1567f241d865c9295c" PRIMARY KEY ("id"))`);
    }
